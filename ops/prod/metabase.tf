module "metabase_database" {
  ...
  postgres_server_id = data.terraform_remote_state.persistent_prod.outputs.postgres_server_id
}
...
module "metabase_service" {
  ...
  ai_instrumentation_key = data.terraform_remote_state.persistent_prod.outputs.app_insights_instrumentation_key
  ...
  postgres_server_fqdn = data.terraform_remote_state.persistent_prod.outputs.postgres_server_fqdn
