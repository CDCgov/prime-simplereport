...
import { handleReportStreamResponse, reportTestEvents } from "./reportingHandlers";
...
describe('reportingHandlers', () => {
    ...
    describe('reportTestEvents', () => {
        ...
        it("calls fetch with correct parameters", async () => {
            ...
            const simpleReportTestEvents: SimpleReportTestEvent[] = [{} as jest.MockedObject<SimpleReportTestEvent>];
    ...
    describe('handleReportStreamResponse', () => {
        ...
        let reportExceptionsSpy, deleteSuccessfullyParsedMessagesSpy ,publishToQueueSpy;

        beforeEach(()=>{
            reportExceptionsSpy =  jest.spyOn(queueHandlers,'reportExceptions');
            deleteSuccessfullyParsedMessagesSpy = jest.spyOn(queueHandlers,'deleteSuccessfullyParsedMessages');
        ...
        it('handles a successful response', async () => {
            ...
            await handleReportStreamResponse(responseMock as Response, context, messagesMock, parseFailureMock, eventQueueMock,
            ...
            expect(deleteSuccessfullyParsedMessagesSpy).toHaveBeenCalledWith(context,eventQueueMock,messagesMock,parseFailureMock);
