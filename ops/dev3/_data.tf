# external state
data "terraform_remote_state" "persistent_dev3" {
  backend = "azurerm"
  config = {
    resource_group_name  = "prime-simple-report-test"
    storage_account_name = "usdssimplereportglobal"
    container_name       = "sr-tfstate"
    key                  = "dev3/persistent-terraform.tfstate"
  }
}
...
data "azurerm_key_vault_secret" "sr_dev3_db_jdbc" {
  name         = "simple-report-dev3-db-jdbc"
