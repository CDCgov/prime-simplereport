module "simple_report_api" {
  ...
  app_settings = {
    SPRING_PROFILES_ACTIVE                        = "azure-dev5"
    SPRING_DATASOURCE_SIMPLEREPORT_HIKARI_JDBCURL = "@Microsoft.KeyVault(SecretUri=${data.azurerm_key_vault_secret.sr_dev5_db_jdbc.id})"
