# external state
data "terraform_remote_state" "persistent_dev2" {
  backend = "azurerm"
  config = {
...
# Network
data "azurerm_virtual_network" "dev2" {
...
data "azurerm_key_vault_secret" "sr_dev2_db_jdbc" {
  name         = "simple-report-dev2-db-jdbc"
