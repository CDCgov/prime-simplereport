module "db_liquibase_action" {
  ...
  spring_datasource_url   = data.azurerm_key_vault_secret.sr_dev4_db_jdbc.value
  subnet_id               = data.terraform_remote_state.persistent_dev4.outputs.subnet_container_instances_id
}
