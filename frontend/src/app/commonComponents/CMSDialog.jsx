...
/** This is a slighty modified copy of the CMS design system Dialog element.
 * If we keep using it, we should probably submit the changes as an enhancement
 * upstream.
 */
export const Dialog = function (props) {
  ...
  const headerActions = actionsInHeader ? (
    actions
  ) : (
    <Button
