          ...
          <MenuButton
            ...
            buttonContent={
              <>
                ...
                <FontAwesomeIcon
                  icon={downloadFacilityPatientsButtonContent.icon as IconProp}
                  className={downloadFacilityPatientsButtonContent.className}
                />
              </>
            }
            items={
  ...
  const getDownloadButtonContent = () => {
    switch (downloadState) {
      ...
      default:
        return {
          icon: faCaretDown,
          label: "Download " + PATIENT_TERM_PLURAL,
          className: "",
        };
    }
  };
          ...
          <div className="prime-container card-container">
            <div className="usa-card__header" data-cy="manage-patients-header">
              <div className="display-flex flex-align-center">
                <h1 className="font-heading-lg margin-y-0">
                  {PATIENT_TERM_PLURAL_CAP}
                </h1>
