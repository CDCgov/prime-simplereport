...
describe("parseCovidSymptoms", () => {
  it("takes a JSON payload of {'COVID symptom SNOMEDS' : boolean strings} and parses the strings into booleans", () => {
    ...
    const parsedPayload = parseRespiratorySymptoms(covidSymptomPayload);
