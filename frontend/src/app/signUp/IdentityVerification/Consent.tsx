        ...
        <Card logo>
          ...
          <div className="margin-bottom-2">
            <p className="font-ui-2xs text-base">
              ...
              — SimpleReport won’t access your identity verification details.
              This process isn’t a formal credit check and won’t impact your
              credit score.
            </p>
            <p className="font-ui-2xs text-base margin-top-0">
              ...
              verify your identity via Experian and, if needed, via their
              identity verification partners — such as your mobile service
              provider. As part of the authorization your mobile service
              provider may disclose to Experian details of your account, if
              available. This authorization allows us to obtain information only
              to verify your identity and to avoid fraudulent activity in your
              name while you are a SimpleReport customer. You can review a
              detailed list of information potentially disclosed and how we use
              your data in our{" "}
              <a
