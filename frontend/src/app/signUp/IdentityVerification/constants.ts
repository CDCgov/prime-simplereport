export const exampleQuestionSet = [
  {
    questionType: 28,
    questionText:
  ...
  },
  {
    questionType: 47,
    questionText:
      "According to your credit profile, you may have opened a Home type loan in or around May 2015. Please select the lender to whom you currently made your payments.",
    questionSelect: {
      questionChoice: [
        "UC LENDING",
        "CTX MORTGAGE",
