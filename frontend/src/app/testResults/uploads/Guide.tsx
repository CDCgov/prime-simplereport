...
const CsvUploadGuide = () => {
  return (
    <>
      <title>
        CSV upload guide | Organizations and testing facilities | Getting
        started | {process.env.REACT_APP_TITLE}
      </title>
            ...
            <div className="tablet:grid-col-8 usa-prose">
              <section id="anchor-top">
                ...
                <p className="usa-intro text-base margin-bottom-4">
                  ...
                  uploading test results via a comma-separated values (CSV)
                  file.
                </p>
                <p>
              ...
              <section>
                ...
                <ol className="usa-process-list">
                  ...
                  <li className="usa-process-list__item">
                    ...
                    <p>
                      Whether you're modifying an existing file or creating a
                      new one from scratch, be sure to include all column
                      headers outlined in the standard file and documentation.
                      Do not include any additional column headers. Make sure
                      headers are written exactly as defined.
                    </p>
                    <p>
                      Include column headers even if you don’t have data for
                      every field.
                    </p>
                  </li>
                  <li className="usa-process-list__item">
                  ...
                  <li className="usa-process-list__item">
                    ...
                    <p>
                      Export your properly formatted CSV with filled-in data.
                    </p>
                    <p>
                      <em>
                        Be sure to save your file as .CSV. SimpleReport CSV
                        upload does not accept files saved as .XLS, .XLXS, or
                        other formats.
                      </em>
                    </p>
                  </li>
                ...
                <ol className="usa-process-list">
                  ...
                  <li className="usa-process-list__item">
                    ...
                    <p className="margin-top-2">
                      "Upload" can be found in the main site navigation at the
                      top of the page.
                    </p>
                  </li>
                  <li className="usa-process-list__item">
                  ...
                  <li className="usa-process-list__item">
                    ...
                    <p>
                      ...
                      the application will alert you to specific changes you
                    ...
                    <ul>
                      ...
                      <li>
                        Make the recommended changes to the file and re-export
                        it as a .CSV
                      </li>
