...
const CsvSchemaDocumentation = () => {
  return (
    <>
      {/*
      <title>
        CSV schema documentation | Organizations and testing facilities |
...
*/}
              ...
              <section className="border-top-1px border-ink margin-top-9">
                ...
                <p>
                  ...
                  If headers or fields are blank or contain incorrect values you
                  will not be able to submit your file. Accepted values are
                  outlined for each header and field below
                </p>
                <p>
