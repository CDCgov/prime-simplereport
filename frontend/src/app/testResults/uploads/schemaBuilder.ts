            ...
            items: [
              {
                ...
                requested: false,
                examples: [
                  "<mark><code>Swab of internal nose</code></mark>",
                  "<mark><code>Nasopharyngeal Swab</code></mark>",
                  "<mark><code>Bronchoalveolar lavage</code></mark>",
                  "<em>258607008</em>",
                  "<em>258500001</em>",
                  "<em>445297001</em>",
                ],
                description: [
                  `Find the specimen type for your device on the ${deviceCodeLookupLink} and copy the text value or nine-digit SNOMED code.`,
                  "<br/>",
