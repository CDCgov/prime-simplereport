...
export const schemaBuilder = (facilityId: string | null) => {
  ...
  const deviceCodeLookupLink = `<a href="${
    import.meta.env.VITE_PUBLIC_URL
  }/results/upload/submit/code-lookup?facility=${validUuid}" class="usa-link" target="_blank" rel="noreferrer noopener">device code lookup tool</a>`;
