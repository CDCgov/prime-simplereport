      ...
      <div className="tablet:grid-col-8 usa-prose">
        <section id="anchor-top">
          ...
          <p className="usa-intro text-base margin-bottom-4">
            Step-by-step guidance for preparing and uploading test results via a
            standard comma-separated values (CSV) spreadsheet.
          </p>
          ...
          <ol className="usa-process-list">
            <li className="usa-process-list__item">
              ...
              <p className="margin-top-05">
                If your jurisdiction already has a set format for CSV, compare
                it to our{" "}
                <a
                  href="https://SimpleReport.cdc.gov/assets/csv/SimpleReport-StandardCSV-ExampleData-20220509.csv"
                  className="usa-link"
            ...
            <li className="usa-process-list__item">
              <h4 className="usa-process-list__heading">
                Format your column headers to match the SimpleReport standard
                CSV
              </h4>
              <p>
                Whether you're modifying an existing file or creating a new one
                from scratch, be sure to include all column headers outlined in
                the standard file and documentation. Do not include any
                additional column headers. Make sure headers are written exactly
                as defined.
              </p>
              <p>
            ...
            <li className="usa-process-list__item">
              ...
              <p>
                <em>
                  ...
                  does not accept files saved as .XLS, .XLXS, or other formats.
                </em>
              </p>
            </li>
          </ol>
          ...
          <ol className="usa-process-list">
            <li className="usa-process-list__item">
              ...
              <p className="margin-top-2">
                You can find "Upload spreadsheet" under "Results" in the main
            ...
            <li className="usa-process-list__item">
              ...
              <ul className="margin-top-2">
                <li>
                  <strong>Option A:</strong> Drag your CSV file from your folder
                  to the upload area.
                </li>
                <li>
            ...
            <li className="usa-process-list__item">
              ...
              <ul className="margin-top-2">
                <li>Click "Upload."</li>
                <li>
                  SimpleReport will validate your file and provide confirmation
              ...
              <p>
                ...
                application will alert you to the specific changes you need to
                make before submitting.
              </p>
              <p>To resolve errors in a CSV:</p>
              <ul>
                <li>
                  Review the list of errors and recommended changes suggested by
                  SimpleReport. Reference the{" "}
                  <a
                    href="/getting-started/testing-facilities/csv-schema"
                    className="usa-link"
                  >
                  ...
                  again for any adjustments you need to make to column headers
                  or values.
                </li>
                <li>
                  Make the recommended changes to the file and re-export it as a
                  .CSV
                </li>
