        ...
        sections: [
          {
            ...
            items: [
              ...
              },
              {
                ...
                acceptedValues: [
                  "<mark><code>male</code></mark>",
                  "<mark><code>female</code></mark>",
                  "<mark><code>other</code></mark>",
                  "<mark><code>m</code></mark>",
                  "<mark><code>f</code></mark>",
                  "<mark><code>o</code></mark>",
                  "<mark><code>u</code></mark>",
                  "<mark><code>ambiguous</code></mark>",
                  "<mark><code>not applicable</code></mark>",
                ],
              },
              {
                name: "Sex",
