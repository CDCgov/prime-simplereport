...
describe("smartStreets", () => {
  describe("buildClient", () => {
    it("throws an error if SmartyStreets API key is not in environment", () => {
      const smartyStreetsAPIKey = process.env.VITE_SMARTY_STREETS_KEY;
      delete process.env.VITE_SMARTY_STREETS_KEY;
      ...
      process.env.VITE_SMARTY_STREETS_KEY = smartyStreetsAPIKey;
    });
  });
