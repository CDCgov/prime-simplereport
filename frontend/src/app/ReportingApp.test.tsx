...
describe("App", () => {
  ...
  describe("logs to App Insights on WhoAmI error", () => {
    const oldTokenClaim = import.meta.env.VITE_OKTA_TOKEN_ROLE_CLAIM;
    const trackExceptionMock = jest.fn();

    beforeEach(() => {
      import.meta.env.VITE_OKTA_TOKEN_ROLE_CLAIM = "test_roles";
    ...
    afterEach(() => {
      import.meta.env.VITE_OKTA_TOKEN_ROLE_CLAIM = oldTokenClaim;
