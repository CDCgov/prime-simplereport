...
import static gov.cdc.usds.simplereport.config.WebConfiguration.*;
...
public class FileUploadController {
    ...
    public TestResultUpload handleConditionAgnosticResultsUpload(
        ...
        try (InputStream resultsUpload = file.getInputStream()) {
            ...
            throw new CsvProcessingException("Unable to process condition agnostic test result CSV upload");
        }
    }
