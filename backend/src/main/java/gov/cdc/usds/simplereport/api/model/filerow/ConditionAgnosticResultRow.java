    ...
    public ConditionAgnosticResultRow(Map<String, String> rawRow) {
        ...
        patientFirstName =
                getValue(
                        rawRow,
                        PATIENT_FIRST_NAME,
                        isRequired(rawRow, PatientNameRelatedField.PATIENT_FIRST_NAME));
        patientLastName =
                getValue(
                        rawRow,
                        PATIENT_LAST_NAME,
                        isRequired(rawRow, PatientNameRelatedField.PATIENT_LAST_NAME));
        patientNameAbsentReason =
                getValue(
                        rawRow,
                        PATIENT_NAME_ABSENT_REASON,
                        isRequired(rawRow, PatientNameRelatedField.PATIENT_NAME_ABSENT_REASON));
