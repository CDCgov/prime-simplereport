...
/**
 * GraphQL resolver for fields of the Organization API model that are no longer fields of the
 * Organization database model. Most of the original content should probably be removed before
 * Christmas 2020.
 */
@Service
