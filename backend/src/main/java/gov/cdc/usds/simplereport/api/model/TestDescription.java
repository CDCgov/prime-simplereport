...
public class TestDescription {
  ...
  private static final TestDescription DEFAULT_TEST =
      new TestDescription("Unknown", "Unknown", "Unknown", "Unknown", "Unknown");

  private static final Map<String, TestDescription> KNOWN_TESTS =
      Map.of(
          "94534-5",
              new TestDescription(
                  "94534-5",
