...
class AzureStorageQueueFhirReportingServiceTest {
    ...
    void reportAsync_NonCovidOnly() {
        ...
        AzureStorageQueueFhirReportingService service =
                new AzureStorageQueueFhirReportingService(context, client, gitProperties, bulkTestResultUploadFhirConverter);
    ...
    void reportAsync_CovidOnly() {
        ...
        var client = mock(QueueAsyncClient.class);
        AzureStorageQueueFhirReportingService service =
                new AzureStorageQueueFhirReportingService(context, client, null, bulkTestResultUploadFhirConverter);
