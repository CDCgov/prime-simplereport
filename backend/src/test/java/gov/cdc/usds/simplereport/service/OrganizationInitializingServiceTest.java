...
//
// class OrganizationInitializingServiceTest extends
// BaseServiceTest<OrganizationInitializingService> {
...
//    @BeforeEach
//  public void setup() {
//        Organization _org = _dataFactory.saveValidOrganization();
...
//        new InitialSetupProperties.ConfigPatient(
//            secondPatientFirstName, secondPatientLastName, secondPatientBirthDate,
// DEFAULT_ORG_ID);
