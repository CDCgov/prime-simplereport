...
public class TestResultBulkUploadToFhirTest {
  ...
  public void beforeEach() {
    ...
    ConvertToFhirForBulkTestUpload fhirConversionStrategy =
        new ConvertToFhirForBulkTestUpload(
            resultsUploaderCachingService,
            gitProperties,
            uuidGenerator,
            dateGenerator,
            bulkTestResultUploadFhirConverter);
    sut = new FhirConversionContext(fhirConversionStrategy);
  }
  ...
  void convertExistingCsv_matchesFhirJson() throws IOException {
    ...
    ConvertToFhirForBulkTestUpload testStrategy =
        new ConvertToFhirForBulkTestUpload(
            resultsUploaderCachingService,
            gitProperties,
            mockedUUIDGenerator,
            mockedDateGenerator,
            new BulkTestResultUploadFhirConverter(mockedUUIDGenerator, mockedDateGenerator));
    sut = new FhirConversionContext(testStrategy);
