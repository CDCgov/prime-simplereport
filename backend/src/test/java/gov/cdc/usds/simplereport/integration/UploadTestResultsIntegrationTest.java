...
import gov.cdc.usds.simplereport.utils.TestResultBulkUploadToFhirTest;
...
class UploadTestResultsIntegrationTest extends BaseAuthenticatedFullStackTest {
    ...
    @MockBean
    private TokenAuthentication _tokenAuth;
    ...
    @SpyBean
    private TestResultBulkUploadToFhir testResultBulkUploadToFhir;
    ...
    void setup() throws IOException {
        ...
        ReflectionTestUtils.setField(
                testResultBulkUploadToFhir, "gitProperties", new GitProperties(properties));
