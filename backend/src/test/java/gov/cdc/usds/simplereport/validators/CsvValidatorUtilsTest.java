...
class CsvValidatorUtilsTest {
  ...
  @Test
  void validZipCode() {
    ValueOrError zipCode = new ValueOrError("21037", "zip_code", false);
    assertThat(validateZipCode(zipCode)).isEmpty();
  }

  @Test
  void invalidZipCode_returnsError() {
    ValueOrError residence = new ValueOrError("2103", "zip_code", false);
    assertThat(validateZipCode(residence)).hasSize(1);
  }

  @Test
  void validPhoneNumber() {
    ValueOrError phoneNumber = new ValueOrError("410-956-1222", "phoneNumber", false);
    assertThat(validatePhoneNumber(phoneNumber)).isEmpty();
  }

  @Test
  void invalidPhoneNumber_returnsError() {
    ValueOrError phoneNumber = new ValueOrError("4109561222", "phoneNumber", false);
  ...
  @Test
  void validEthnicity() {
    ValueOrError ethnicity = new ValueOrError("hispanic or latino", "ethnicity", false);
    assertThat(validateEthnicity(ethnicity)).isEmpty();
  }

  @Test
  void invalidEthnicity_returnsError() {
    ValueOrError ethnicity = new ValueOrError("latinx", "ethnicity", false);
  ...
  void twoYearDate_passesFlexibleValidation() {
    ValueOrError birthDate = new ValueOrError("11/3/80", "date_of_birth", false);
    assertThat(validateFlexibleDate(birthDate)).isEmpty();
  }

  @Test
  void invalidDate_doesNotPassFlexibleValidation() {
    ValueOrError birthDate = new ValueOrError("0/3/1980", "date_of_birth", false);
  ...
  void validCountryCode() {
    var countryCode = new ValueOrError("USA", "country", false);
    assertThat(validateCountry(countryCode)).isEmpty();
  }

  @Test
  void validSpecimenName() {
    var specimenType = new ValueOrError("Oral saliva sample", "specimen_type", false);
  ...
  void validSpecimenSNOMED() {
    var specimenType = new ValueOrError("012345678", "specimen_type", false);
    assertThat(validateSpecimenType(specimenType, Map.of("oral saliva sample", "000111222")))
        .isEmpty();
  }
  ...
  void invalidSpecimenSNOMED() {
    // too many characters
    var specimenType = new ValueOrError("0123456789", "specimen_type", false);
    assertThat(validateSpecimenType(specimenType, Map.of("oral saliva sample", "000111222")))
        .hasSize(1);
  }
  ...
  void validDateFormat() {
    ...
    validDates.add(new ValueOrError("01/01/2023", "date", false));
    validDates.add(new ValueOrError("1/1/2023", "date", false));
    validDates.add(new ValueOrError("1/01/2023", "date", false));
    validDates.add(new ValueOrError("01/1/2023", "date", false));
    validDates.add(new ValueOrError("1/31/2023", "date", false));
    validDates.add(new ValueOrError("12/01/2023", "date", false));
  ...
  void invalidDateFormat() {
    ...
    invalidDates.add(new ValueOrError("00/01/2023", "date", false));
    invalidDates.add(new ValueOrError("1/32/2023", "date", false));
    invalidDates.add(new ValueOrError("1/1/23", "date", false));
    invalidDates.add(new ValueOrError("11/00/2023", "date", false));
    invalidDates.add(new ValueOrError("0/31/2023", "date", false));
    invalidDates.add(new ValueOrError("10/0/2023", "date", false));
    invalidDates.add(new ValueOrError("00/00/2023", "date", false));
    invalidDates.add(new ValueOrError("0/0/2023", "date", false));
    invalidDates.add(new ValueOrError("0/0/202", "date", false));
  ...
  void validDateTime() {
    ...
    validDateTimes.add(new ValueOrError("01/01/2023 11:11", "datetime", false));
    validDateTimes.add(new ValueOrError("1/1/2023 12:34", "datetime", false));
    validDateTimes.add(new ValueOrError("1/01/2023 23:59", "datetime", false));
    validDateTimes.add(new ValueOrError("01/1/2023 00:00", "datetime", false));
    validDateTimes.add(new ValueOrError("1/31/2023 05:50", "datetime", false));
    validDateTimes.add(new ValueOrError("12/01/2023 1:01", "datetime", false));
  ...
  void invalidDateTime() {
    ...
    invalidDateTimes.add(new ValueOrError("00/01/2023 11:60", "datetime", false));
    invalidDateTimes.add(new ValueOrError("1/32/2023 1:50", "datetime", false));
    invalidDateTimes.add(new ValueOrError("1/1/23 12:34", "datetime", false));
    invalidDateTimes.add(new ValueOrError("11/00/2023 52:37", "datetime", false));
    invalidDateTimes.add(new ValueOrError("0/31/2023 5:29", "datetime", false));
    invalidDateTimes.add(new ValueOrError("10/0/2023 6:15", "datetime", false));
    invalidDateTimes.add(new ValueOrError("00/00/2023 07:30", "datetime", false));
    invalidDateTimes.add(new ValueOrError("0/0/2023 10:23", "datetime", false));
    invalidDateTimes.add(new ValueOrError("0/0/202 11:11", "datetime", false));
