...
class TestResultUploadServiceTest extends BaseServiceTest<TestResultUploadService> {
  ...
  void setup() {
    ...
    uploadRepository.save(
        new BulkTestResultUpload(
            REPORT_ID_1, UploadStatus.SUCCESS, 30, currentOrganization, facility, null, null));

    mockCreationTime("2021-02-17 00:00");
    uploadRepository.save(
        new BulkTestResultUpload(
            REPORT_ID_2, UploadStatus.PENDING, 20, currentOrganization, facility, null, null));
  ...
  @Test
  public void getUploadSubmissions_start_date_end_date() {
    // GIVEN
  ...
  @Test
  public void getUploadSubmissions_start_date_null() {
    // GIVEN
  ...
  @Test
  public void getUploadSubmissions_end_date_null() {
    // GIVEN
