...
public class TestEventRepositoryTest extends BaseRepositoryTest {
    ...
    public void testLatestTestEventForPerson() {
        ...
        List<TestEvent> foundTestReports1 = _repo.findAllByCreatedAtBetweenOrderByCreatedAtDesc(d1, DATE_1MIN_FUTURE);
        Organization org = _dataFactory.createValidOrg();
        Facility place = _dataFactory.createValidFacility(org);
        Person patient = _dataFactory.createMinimalPerson(org);
        ...
        List<TestEvent> foundTestReports2 = _repo.findAllByCreatedAtBetweenOrderByCreatedAtDesc(d1, DATE_1MIN_FUTURE);
